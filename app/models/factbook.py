...
class Country(db.Model):
    ...
    pays_resource = db.relationship(
    'Resources', secondary=country_resourses,
    primaryjoin=(country_resourses.c.id == id),
    secondaryjoin=(country_resourses.c.resource == id),
...
class Resources(db.Model):
    ...
    resource_country = db.relationship(
    'Country', secondary=country_resourses,
    primaryjoin=(country_resourses.c.id == id),
    secondaryjoin=(country_resourses.c.resource == id),
    backref=db.backref('pays', lazy='dynamic'), lazy='dynamic')
